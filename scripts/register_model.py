...
EXPERIMENT_NAME =     # ваш код здесь (уникальное имя эксперимента)
RUN_NAME = 
REGISTRY_MODEL_NAME =  # можно поменять на своё имя

# ==== 2) Доступ к S3 ====
os.environ["MLFLOW_S3_ENDPOINT_URL"] =    # ваш код здесь
os.environ["AWS_ACCESS_KEY_ID"] =               # ваш код здесь
os.environ["AWS_SECRET_ACCESS_KEY"] =   # ваш код здесь
